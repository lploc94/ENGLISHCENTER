...
namespace BusinessLogicLayer.service
{
    public class PhongHoc
    {
        ...
        public static int insert(string id, string pass, int maphong, int tang, int sophong)
        {
        ...
        public static int delete(string id, string pass, string maph) //id và pass của nhân viên không phải id và pass của giảng viên
        {
            if (CheckService.checkID(id, pass) == 1)
            {
        ...
        public static DataTable get(string id, string pass, string maph)
        {
            if (CheckService.checkID(id, pass) == 1)
            {
